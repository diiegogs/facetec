...
export const SampleAppUtilities = (function() {
  ...
  function fadeOutMainUIAndPrepareForSession() {
    ...
    if(isLikelyMobileDevice()) {
      UI("#custom-logo-container");
    }
    UI("#controls").fadeOut(800);
    UI(".wrapping-box-container");
  }
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  function formatUIForDevice() {
    if(isLikelyMobileDevice()===null) {
      ...
      (document.getElementById("controls") as HTMLElement).style.borderColor = "red";
